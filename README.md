...
• Використання менеджера контексту with для безпечного відкриття та закриття файлів.



• Використання блоку try-except для опрацювання можливих винятків, таких як відсутність файлу або помилки читання.
...
• Застосування встановлення кодування при читанні файлів, щоб уникнути проблем із символами.



• Додавання словників до списку для подальшого повернення. Використання блоку try-except для опрацювання можливих винятків, таких як відсутність файлу або помилки читання.



• Створення та використання функції для групування коду та підвищення його перевикористовуваності.



• Обробка аргументів командного рядка за допомогою модуля sys.



• Використання модуля pathlib для роботи з шляхами та отримання інформації про файли та директорії.



• Створення та активація віртуального оточення для ізоляції залежностей проєкту.



• Використання бібліотеки colorama для кольорового форматування виводу та полегшення візуального сприйняття.



• Розробка скрипту, що може рекурсивно обходити директорії для відображення їхньої структури.



🎈 Зверни, увагу, що третє завдання не обов’язкове (хоча і дуже цікаве).
Для того, щоб ефективніше працювати над завданнями, рекомендуємо:


◦ “Їсти слона по частинам”. Це нормально, якщо всі правильні відповіді не приходять при першому контакті із завданням. Інколи для виконання завдання зручніше напочатку декомпозувати і розбиратися з окремими частинами коду поетапно. Можливо, те, що не зрозуміло сьогодні, проясниться завтра.



◦ Не залишати домашнє завдання на останній день. Витікає з попереднього пункту. Одного дня безперечно недостатньо для виконання всіх завдань. Чим раніше ви почнете думати над ними, тим більше цікавих рішень прийде.



◦ Порадитися з чатом GPT. Якщо ви ще не пробували звертатись за допомогою до чату, радимо спробувати. Завдання він замість тебе не розв’яже, але може перевірити код, надати робочі поради і підбадьорити.



◦ Зберігати мотивацію. Пам’ятайте, що тестові завдання на роботу та реальні робочі задачі будуть містити те, що ви вчите зараз. Краще порадитися з чатом, ментором, викладачем і групою, і виконати завдання зараз, ніж “плавати” в реальних робочих задачах.
...
📌 Для здачі домашнього завдання розмістіть файли з розв'язанням у репозиторії goit-algo-hw-04, та прикріпіть лінки до них у відповідь на домашнє завдання.
